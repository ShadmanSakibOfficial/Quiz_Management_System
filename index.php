...
<body>
    ...
    <header class="header">
        ...
        <nav class="navbar">
            ...
            <a href="http://localhost/quiz_game-main/html/login.php">Quiz</a>
            <a href=".\Html\result.php">results</a>
    ...
    <section class="home" id="home">
        ...
        <div class="content">
            ...
            <p>In this day and time, with no competition you are really walking a tightrope. I mean you may think that no competition is good, but in reality no competition is really bad.</p>
    ...
    <section class="menu" id="menu">
        ...
        <h1 class="heading1"> our <span>Course</span> </h1>
        ...
        <div class="box-container">
            ...
            <div class="box">
                ...
                <a href="http://localhost/quiz_game-main/html/login.php" class="btn">See Quiz</a>
            </div>
    ...
    <section class="review" id="review">
        ...
        <h1 class="heading1"> <span>Instructor's</span> Word</h1>
        ...
        <div class="row">
            ...
            <form action="">
                ...
                <div class="inputBox">
                    ...
                    <input type="number" placeholder="Your Text">
                </div>
